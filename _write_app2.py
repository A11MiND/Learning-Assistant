#!/usr/bin/env python3
"""Generator: writes the new professional app.py"""
import os
...
BADGE = '<span class="badge badge-{cls}">{txt}</span>'
...
# Embed CSS into app code
app_code = APP.replace('CSS = """' + css_block + r'"""', f'CSS = """{css_block}"""')

with open('app.py', 'w', encoding='utf-8') as f:
    f.write(app_code)
print(f"app.py written: {len(app_code)} chars, ~{app_code.count(chr(10))} lines")
